...
def preprocess_data():
    ...
    # Save Processed Data
    df_examples.to_parquet('rag_application/shopping_queries_dataset/processed_examples.parquet')
    # df_products.to_parquet('rag_application/shopping_queries_dataset/processed_products.parquet')
    df_sources.to_csv('rag_application/shopping_queries_dataset/processed_sources.csv', index=False)
